...
@class DLWConfigReader, DLWConfigRulesSearchController, NSMutableArray, NSString, UISearchController;

@interface DLWConfigRulesViewController : DLWTableViewController <UISearchControllerDelegate>
{
    ...
    DLWConfigRulesSearchController *_searchResultController;
}

@property(retain, nonatomic) DLWConfigRulesSearchController *searchResultController; // @synthesize searchResultController=_searchResultController;
