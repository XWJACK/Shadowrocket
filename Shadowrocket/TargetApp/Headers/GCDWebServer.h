...
@interface GCDWebServer : NSObject
{
    ...
    struct dispatch_group_s *_sourceGroup;
    ...
    struct dispatch_source_s *_source4;
    struct dispatch_source_s *_source6;
...
- (struct dispatch_source_s *)_createDispatchSourceWithListeningSocket:(int)arg1 isIPv6:(_Bool)arg2;
